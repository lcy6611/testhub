...
class Defect(models.Model):
    ...
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name='oss_defects', verbose_name='所属项目')
    version = models.ForeignKey(
        Version,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name='oss_defects_version',
        verbose_name='所属版本',
    )
    ...
    reporter = models.ForeignKey(User, on_delete=models.CASCADE, related_name='oss_reported_defects', verbose_name='提交人')
    assignee = models.ForeignKey(
        User,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name='oss_assigned_defects',
        verbose_name='处理人',
    )
    verifier = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='oss_verify_defects',
        verbose_name='验证人',
    )
    resolver = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='oss_resolved_defects',
        verbose_name='修复人',
    )
    related_testcase = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='oss_defects_testcase',
        verbose_name='关联用例',
    )
    related_requirement = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='oss_defects_requirement',
        verbose_name='关联需求',
    )
    related_test_run = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='oss_defects_testrun',
        verbose_name='关联测试执行',
    )
    ...
    class Meta:
        db_table = 'defects_oss'
        verbose_name = 'Bug缺陷(开源对比)'
...
class DefectTransition(models.Model):
    ...
    operator = models.ForeignKey(User, on_delete=models.CASCADE, related_name='oss_defect_transitions', verbose_name='操作人')
    target_user = models.ForeignKey(
        User,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name='oss_defect_transition_targets',
        verbose_name='目标处理人',
    )
    ...
    class Meta:
        db_table = 'defects_oss_transitions'
        verbose_name = '缺陷流转记录'
...
class DefectComment(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='oss_defect_comments', verbose_name='评论人')
    content = models.TextField(verbose_name='评论内容')
    created_at = models.DateTimeField(default=timezone.now, verbose_name='评论时间')

    class Meta:
        db_table = 'defects_oss_comments'
        verbose_name = '缺陷评论'
...
class DefectAttachment(models.Model):
    ...
    uploaded_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='oss_defect_attachments', verbose_name='上传人')
    uploaded_at = models.DateTimeField(default=timezone.now, verbose_name='上传时间')

    class Meta:
        db_table = 'defects_oss_attachments'
        verbose_name = '缺陷附件'
