...
class BusinessRequirementSimpleSerializer(serializers.ModelSerializer):
    class Meta:
        model = BusinessRequirement
        fields = ('id', 'requirement_id', 'requirement_name')
...
class DefectListSerializer(serializers.ModelSerializer):
    ...
    related_requirement = BusinessRequirementSimpleSerializer(read_only=True)
    related_test_run = TestRunSimpleSerializer(read_only=True)
...
class DefectWriteSerializer(serializers.ModelSerializer):
    ...
    related_requirement_id = serializers.IntegerField(required=False, allow_null=True, write_only=True)
    related_test_run_id = serializers.IntegerField(required=False, allow_null=True, write_only=True)
    ...
    def validate(self, attrs):
        ...
        related_requirement = self._get_related_value(attrs, 'related_requirement_id', BusinessRequirement, 'related_requirement')
        related_test_run = self._get_related_value(attrs, 'related_test_run_id', TestRun, 'related_test_run')
        ...
        attrs['related_requirement'] = related_requirement
        attrs['related_test_run'] = related_test_run
        return attrs
