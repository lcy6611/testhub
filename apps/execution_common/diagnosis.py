...
_RULES = [
    ...
    ('element not found', FailureCategory.ELEMENT_NOT_FOUND, '未找到目标元素'),
    ('no such element', FailureCategory.ELEMENT_NOT_FOUND, '未找到目标元素'),
    ('ui object not found', FailureCategory.ELEMENT_NOT_FOUND, '未找到目标元素'),
