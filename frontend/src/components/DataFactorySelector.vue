  ...
  >
    <div class="data-factory-selector">
      <el-tabs v-model="activeTab" @tab-change="handleTabChange">
        <el-tab-pane label="按标签" name="byTag">
          <div class="tag-selector">
            <el-form :inline="true" @submit.prevent="fetchRecordsByTag">
              ...
              <el-form-item>
                <el-button type="primary" @click="fetchRecordsByTag">搜索</el-button>
              </el-form-item>
            </el-form>
            ...
            >
              ...
              <el-table-column prop="tool_category" label="分类" min-width="100" />
        ...
        <el-tab-pane label="按记录" name="byRecord">
    ...
    <div v-if="previewRecordData" class="preview-content">
      <el-descriptions :column="1" border>
        ...
        <el-descriptions-item label="工具分类">
          {{ previewRecordData.tool_category }}
        </el-descriptions-item>
...
const fetchRecordsByTag = async () => {
  ...
  try {
    ...
    total.value = response.data.count || records.value.length
  } catch (error) {
