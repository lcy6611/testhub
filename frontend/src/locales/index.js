...
import zhCnLlmJudge from './lang/zh-cn/llm-judge.js'
import enLlmJudge from './lang/en/llm-judge.js'

// 仅注册「监控中心」「缺陷(开源对比)」「MCP 控制台」与「智能评分器」模块的国际化文案（其余模块当前未接入 i18n，保持最小侵入）。
// 命名空间 monitor / defects_oss / mcp / llmJudge 与源项目 locales 结构一致（t('mcp.tabTools') 等）。
const messages = {
  'zh-cn': {
    monitor: zhCnMonitor,
    defects_oss: zhCnDefectsOss,
    mcp: zhCnMcp,
    llmJudge: zhCnLlmJudge,
