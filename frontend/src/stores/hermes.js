...
export const useHermesStore = defineStore('hermes', () => {
  ...
  function appendUserMessage(content, images = []) {
    const msg = { role: 'user', content, images }
    messages.value.push(msg)
    syncToConversation(msg)
    return msg
  }
  ...
  function createAssistantPlaceholder() {
    ...
    syncToConversation(assistantMsg)
    return assistantMsg
  }

  // 把当前会话的消息同步进内存中的会话对象，避免切换会话后消息被清空
  function syncToConversation(msg) {
