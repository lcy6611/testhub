    ...
    <div class="charts-container">
        ...
        <el-card shadow="never" class="chart-card">
          <template #header>
            <div class="card-header">
              <span>状态分布</span>
              <el-button text type="primary" @click="router.push('/defects_oss/list')">查看列表</el-button>
            </div>
          </template>
      ...
      <el-card shadow="never" class="chart-card trend-card">
        <template #header>
          <div class="card-header">
            <span>缺陷趋势</span>
            <el-button text type="primary" @click="router.push('/defects_oss/reports')">查看报表</el-button>
          </div>
        </template>
...
import { getDefectSummary, getDefectTrend } from '@/api/defects_oss'
import {
  getOptionLabel,
  severityOptions,
  statusOptions
