  ...
  <div class="page-container">
    <div class="page-header">
      ...
      <div class="header-actions">
        ...
        <el-button type="primary" @click="router.push('/defects_oss/create')">
      ...
      >
        ...
        <el-table-column prop="code" label="编号" width="150">
          <template #default="{ row }">
            <el-link type="primary" @click="router.push(`/defects_oss/${row.id}`)">{{ row.code || `#${row.id}` }}</el-link>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="170" fixed="right">
          <template #default="{ row }">
            <el-button size="small" @click="router.push(`/defects_oss/${row.id}`)">详情</el-button>
            <el-button size="small" type="primary" @click="router.push(`/defects_oss/${row.id}/edit`)">编辑</el-button>
          </template>
        </el-table-column>
      </el-table>
...
import { bulkActionDefects, exportDefects, getDefects } from '@/api/defects_oss'
import {
  getOptionLabel,
  getOptionType,
  priorityOptions,
