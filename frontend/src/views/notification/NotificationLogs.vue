        ...
        >
          <template #default="{ row }">
            <el-tag
                ...
                :style="getNotificationTypeTagStyle(row.notification_type_display)"
                effect="light"
                size="small"
            >
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="通知类型">
              <el-tag
                  :type="getNotificationTypeTagType(selectedLog.notification_type_display)"
                  :style="getNotificationTypeTagStyle(selectedLog.notification_type_display)"
                  effect="light"
              >
            ...
            <el-form-item label="通知内容">
              <div class="notification-content">
                ...
                <div v-else class="notification-content-raw">
                  <pre>{{ selectedLog.formatted_notification_content || selectedLog.notification_content || '-' }}</pre>
                </div>
              </div>
            </el-form-item>
          </el-col>
