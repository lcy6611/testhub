                ...
                <el-row :gutter="20">
                  ...
                  <el-col :span="24">
                    <el-form-item label="业务类型">
                      ...
                      <el-checkbox v-model="webhookBots.feishu.enable_ai_testing">AI测试</el-checkbox>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row :gutter="20">
                  ...
                  <el-col :span="24">
                    <el-form-item label="业务类型">
                      ...
                      <el-checkbox v-model="webhookBots.wechat.enable_ai_testing">AI测试</el-checkbox>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row :gutter="20">
                  ...
                  <el-col :span="24">
                    <el-form-item label="业务类型">
                      ...
                      <el-checkbox v-model="webhookBots.dingtalk.enable_ai_testing">AI测试</el-checkbox>
                    </el-form-item>
                  </el-col>
                </el-row>
      ...
      try {
        ...
        if (webhookConfigId) {
          ...
          const botData = {
            ...
            enable_ui_automation: botConfig.enable_ui_automation !== false,
            enable_api_testing: botConfig.enable_api_testing !== false,
            enable_ai_testing: botConfig.enable_ai_testing !== false
          }
      ...
      try {
        ...
        if (response.data.results && response.data.results.length > 0) {
          ...
          if (config.webhook_bots && config.webhook_bots[botType]) {
            ...
            webhookBots[botType].enable_ai_testing = bot.enable_ai_testing !== false
